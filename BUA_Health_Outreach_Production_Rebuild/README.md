...
## Version 2.4 enterprise experience

The public programme gateway, one-question registration journey and Zendale company profile have been rebuilt with a restrained enterprise healthcare design. The registration review and consent are now separate screens, email is compulsory, and duplicate browser retries no longer fail silently. See `RELEASE_NOTES_V2.4.md`.
