...
function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) { return <div className={cn("rounded-[22px] border border-[#e1ddd4] bg-white text-[var(--card-foreground)]", className)} {...props} />; }
...
function CardTitle({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) { return <h3 className={cn("text-lg font-semibold tracking-[-0.02em]", className)} {...props} />; }
